...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void detail_alert(String name_st, String phone_st, String service_st) {
        ...
        call.setOnClickListener(view -> {
            ...
            intent.setData(Uri.parse("tel:" + phone_st));
            MainActivity.this.startActivity(intent);
        });
        message_btn.setOnClickListener(view -> {
            String contact = phone_st; // use country code with your phone number
            if (phone_st.length() == 11) {
                contact = "+92" + phone_st.substring(1, 11);
